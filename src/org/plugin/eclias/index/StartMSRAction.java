		    ...
		    Listener listener = new Listener() {
		      ...
		      public void handleEvent(Event event) {
				...
				try {
					...
					MainDownloadSVNCommits.testDownloadSVNCommitsArgoUML(repoAddressText, startRevisionText, endRevisionText);
		        ...
		        dialog.close();
		        MessageDialog.openInformation(shell, "SVN Options", "The data has been saved in the folder:" + MainGoldSetsGeneratorFromSVNCommits.outputFolder);
		      }
		    };
